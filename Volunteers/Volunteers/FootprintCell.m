...
NSString *const kCellOperationButtonClickedNotification = @"CellOperationButtonClickedNotification";
...
@implementation FootprintCell
{
    ...
    CellCommentView *_commentView;
    BOOL _shouldOpenContentLabel;
    CellOperationMenu *_operationMenu;
}
...
- (void)setup
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(receiveOperationButtonClickedNotification:) name:kCellOperationButtonClickedNotification object:nil];
    ...
    _commentView = [CellCommentView new];
    ...
    _operationMenu = [CellOperationMenu new];
...
{
    [[NSNotificationCenter defaultCenter] postNotificationName:kCellOperationButtonClickedNotification object:_operationButton];
}
